...
class BookingBusiness
{
    public static function makeBooking($request)
    {
        ...
        if($serviceUnavailable){
            ...
            if(strtotime($request->time_start) >= strtotime($serviceUnavailable->time_start) && strtotime($request->time_start) < strtotime($serviceUnavailable->time_end)) return "service is not available in this time period";
        }
